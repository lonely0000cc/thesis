...
class VGG19(nn.Module):
    def __init__(self, final_layer, prev_layer, pretrain=False):
        super(VGG19, self).__init__()

        self.mean_pixel = (123.68, 116.779, 103.939)
        vgg19_cfg = ['conv_1-1', 'relu_1-1', 'conv_1-2', 'relu_1-2', 'pool_1',
        ...
        for idx, layer_name in enumerate(vgg19_cfg):
            ...
            if type_name == 'pool':
                ...
                if layer_name in prev_layer:
                    self.prev_relu_idx.append(idx)
            else:
