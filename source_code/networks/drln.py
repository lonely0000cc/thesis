...
class CALayer(nn.Module):
    def __init__(self, channel, reduction=16):
        ...
        self.c1 = basenet.BasicBlock(channel , channel // reduction, 3, 1, 3, 3)
        self.c2 = basenet.BasicBlock(channel , channel // reduction, 3, 1, 5, 5)
        self.c3 = basenet.BasicBlock(channel , channel // reduction, 3, 1, 7, 7)
        self.c4 = basenet.BasicBlockSig((channel // reduction)*3, channel , 3, 1, 1)
...
class Block(nn.Module):
    def __init__(self, in_channels, out_channels, group=1):
        ...
        self.r1 = basenet.ResidualBlock(in_channels, out_channels)
        self.r2 = basenet.ResidualBlock(in_channels*2, out_channels*2)
        self.r3 = basenet.ResidualBlock(in_channels*4, out_channels*4)
        self.g = basenet.BasicBlock(in_channels*8, out_channels, 1, 1, 0)
