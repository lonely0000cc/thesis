...
class UpPWCDCNet(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        """
        super(UpPWCDCNet,self).__init__()
        ...
        nd = (2*md+1)**2
        dd = np.cumsum([128, 128, 96, 64, 32, 16, 3])
        ...
        self.conv6_3 = conv(od+dd[2],64,  kernel_size=3, stride=1)
        self.conv6_4 = conv(od+dd[3],32,  kernel_size=3, stride=1)
        self.conv6_5 = conv(od+dd[4],16,  kernel_size=3, stride=1)
        self.conv6_6 = conv(od+dd[5],3,   kernel_size=3, stride=1)
        self.predict_flow6 = predict_flow(od+dd[6])
        self.deconv6 = deconv(2, 2, kernel_size=4, stride=2, padding=1) 
        self.upfeat6 = deconv(od+dd[6], 2, kernel_size=4, stride=2, padding=1) 
        ...
        self.conv5_3 = conv(od+dd[2],64,  kernel_size=3, stride=1)
        self.conv5_4 = conv(od+dd[3],32,  kernel_size=3, stride=1)
        self.conv5_5 = conv(od+dd[4],16,  kernel_size=3, stride=1)
        self.conv5_6 = conv(od+dd[5],3,   kernel_size=3, stride=1)
        self.predict_flow5 = predict_flow(od+dd[6]) 
        self.deconv5 = deconv(2, 2, kernel_size=4, stride=2, padding=1) 
        self.upfeat5 = deconv(od+dd[6], 2, kernel_size=4, stride=2, padding=1) 
        ...
        self.conv4_3 = conv(od+dd[2],64,  kernel_size=3, stride=1)
        self.conv4_4 = conv(od+dd[3],32,  kernel_size=3, stride=1)
        self.conv4_5 = conv(od+dd[4],16,  kernel_size=3, stride=1)
        self.conv4_6 = conv(od+dd[5],3,   kernel_size=3, stride=1)
        self.predict_flow4 = predict_flow(od+dd[6]) 
        self.deconv4 = deconv(2, 2, kernel_size=4, stride=2, padding=1) 
        self.upfeat4 = deconv(od+dd[6], 2, kernel_size=4, stride=2, padding=1) 
        ...
        self.conv3_3 = conv(od+dd[2],64,  kernel_size=3, stride=1)
        self.conv3_4 = conv(od+dd[3],32,  kernel_size=3, stride=1)
        self.conv3_5 = conv(od+dd[4],16,  kernel_size=3, stride=1)
        self.conv3_6 = conv(od+dd[5],3,   kernel_size=3, stride=1)
        self.predict_flow3 = predict_flow(od+dd[6]) 
        self.deconv3 = deconv(2, 2, kernel_size=4, stride=2, padding=1) 
        self.upfeat3 = deconv(od+dd[6], 2, kernel_size=4, stride=2, padding=1) 
        ...
        self.conv2_3 = conv(od+dd[2],64,  kernel_size=3, stride=1)
        self.conv2_4 = conv(od+dd[3],32,  kernel_size=3, stride=1)
        self.conv2_5 = conv(od+dd[4],16,  kernel_size=3, stride=1)
        self.conv2_6 = conv(od+dd[5],3,   kernel_size=3, stride=1)
        self.predict_flow2 = predict_flow(od+dd[6]) 
        self.deconv2 = deconv(2, 2, kernel_size=4, stride=2, padding=1) 
        self.upfeat2 = deconv(od+dd[6], 2, kernel_size=4, stride=2, padding=1)
        ...
        self.conv1_5 = conv(od+dd[4],16,  kernel_size=3, stride=1)
        self.conv1_6 = conv(od+dd[5],3,   kernel_size=3, stride=1)
        self.predict_flow1 = predict_flow(od+dd[6]) 
        self.deconv1 = deconv(2, 2, kernel_size=4, stride=2, padding=1) 
        self.upfeat1 = deconv(od+dd[6], 2, kernel_size=4, stride=2, padding=1) 

        od = nd+3+4
        self.conv0_0 = conv(od,      128, kernel_size=3, stride=1)
        self.conv0_1 = conv(od+dd[0],128, kernel_size=3, stride=1)
        self.conv0_2 = conv(od+dd[1],96,  kernel_size=3, stride=1)
        self.conv0_3 = conv(od+dd[2],64,  kernel_size=3, stride=1)
        self.conv0_4 = conv(od+dd[3],32,  kernel_size=3, stride=1)
        self.conv0_5 = conv(od+dd[4],16,  kernel_size=3, stride=1)
        self.conv0_6 = conv(od+dd[5],3,   kernel_size=3, stride=1)
        self.predict_flow0 = predict_flow(od+dd[6]) 
        #self.deconv0 = deconv(2, 2, kernel_size=4, stride=2, padding=1) 
        #self.upfeat0 = deconv(od+dd[6], 2, kernel_size=4, stride=2, padding=1) 
        
        self.dc_conv1 = conv(od+dd[6], 128, kernel_size=3, stride=1, padding=1,  dilation=1)
        self.dc_conv2 = conv(128,      128, kernel_size=3, stride=1, padding=2,  dilation=2)
        self.dc_conv3 = conv(128,      128, kernel_size=3, stride=1, padding=4,  dilation=4)
        self.dc_conv4 = conv(128,      96,  kernel_size=3, stride=1, padding=8,  dilation=8)
        self.dc_conv5 = conv(96,       64,  kernel_size=3, stride=1, padding=16, dilation=16)
        self.dc_conv6 = conv(64,       32,  kernel_size=3, stride=1, padding=32, dilation=32)
        self.dc_conv7 = conv(32,       16,  kernel_size=3, stride=1, padding=64, dilation=64)
        self.dc_conv8 = conv(16,        3,  kernel_size=3, stride=1, padding=128,dilation=128)
        self.dc_conv9 = predict_flow(3)
    ...
    def forward(self,im1, im2):        
        ...
        x = torch.cat((self.conv6_3(x), x),1)
        x = torch.cat((self.conv6_4(x), x),1)
        x = torch.cat((self.conv6_5(x), x),1)
        x = torch.cat((self.conv6_6(x), x),1)
        flow6 = self.predict_flow6(x)
        up_flow6 = self.deconv6(flow6)
        up_feat6 = self.upfeat6(x)
        ...
        x = torch.cat((self.conv5_3(x), x),1)
        x = torch.cat((self.conv5_4(x), x),1)
        x = torch.cat((self.conv5_5(x), x),1)
        x = torch.cat((self.conv5_6(x), x),1)
        flow5 = self.predict_flow5(x)
        up_flow5 = self.deconv5(flow5)
        up_feat5 = self.upfeat5(x)
        ...
        x = torch.cat((self.conv4_3(x), x),1)
        x = torch.cat((self.conv4_4(x), x),1)
        x = torch.cat((self.conv4_5(x), x),1)
        x = torch.cat((self.conv4_6(x), x),1)
        flow4 = self.predict_flow4(x)
        up_flow4 = self.deconv4(flow4)
        up_feat4 = self.upfeat4(x)
        ...
        x = torch.cat((self.conv3_3(x), x),1)
        x = torch.cat((self.conv3_4(x), x),1)
        x = torch.cat((self.conv3_5(x), x),1)
        x = torch.cat((self.conv3_6(x), x),1)
        flow3 = self.predict_flow3(x)
        up_flow3 = self.deconv3(flow3)
        up_feat3 = self.upfeat3(x)
        ...
        x = torch.cat((self.conv2_3(x), x),1)
        x = torch.cat((self.conv2_4(x), x),1)
        x = torch.cat((self.conv2_5(x), x),1)
        x = torch.cat((self.conv2_6(x), x),1)
        flow2 = self.predict_flow2(x)
        ...
        x = torch.cat((self.conv1_5(x), x),1)
        x = torch.cat((self.conv1_6(x), x),1)
        flow1 = self.predict_flow1(x)
        up_flow1 = self.deconv1(flow1)
        up_feat1 = self.upfeat1(x)

        warp0 = self.warp(im2, up_flow1*20.0) 
        corr0 = self.corr(im1, warp0)
        ...
        x = torch.cat((self.conv0_5(x), x),1)
        x = torch.cat((self.conv0_6(x), x),1)
        flow0 = self.predict_flow0(x)
 
        x = self.dc_conv4(self.dc_conv3(self.dc_conv2(self.dc_conv1(x))))
        flow0 += self.dc_conv9(self.dc_conv8(self.dc_conv7(self.dc_conv6(self.dc_conv5(x)))))
